...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($from_city) && !empty($to_city)) {
        // Fetch schedules for 'plane' mode based on from_city and to_city
        ...
        if ($result) {
            ...
            error_log("Database error in get_plane_schedules.php: " . mysqli_error($conn));
        }
    }
}
